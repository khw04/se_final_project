...
- 운영 RDS에 `DB_SSL_MODE=VERIFY_IDENTITY`를 적용하려면 RDS CA truststore를 `./certs`에 마운트하고 `DB_SSL_PARAMS`를 설정합니다. (자세한 내용은 `doc/배포_실행_순서.md`, `doc/PR21_AWS_RDS_초기화_배포_체크리스트.md`)
...
| `doc/배포_실행_순서.md` | 배포 절차 |
| `doc/PR21_AWS_RDS_초기화_배포_체크리스트.md` | RDS 초기화·배포 체크리스트 |
| `doc/최종_smoke_test_체크리스트.md` | 배포 후 스모크 테스트 |
| `doc/OWASP_Top10_점검표.md` · `doc/보안_점검_요약.md` | 보안 점검 |
| `doc/개인정보_처리_및_보안_정책.md` | 개인정보·보안 정책 |
| `doc/성능_부하_검증.md` | 성능 부하 검증 결과 |
