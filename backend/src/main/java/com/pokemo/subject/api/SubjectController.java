...
public class SubjectController {
  ...
  SubjectResponse create(@Valid @RequestBody CreateSubjectRequest request) {
    return subjectService.create(request);
  }

  @PutMapping("/{id}")
  SubjectResponse update(@PathVariable Long id, @Valid @RequestBody CreateSubjectRequest request) {
